...
STRING_PRINT_DEBUG			=	"$(COLOR_SHELL_DEBUG)[----------]\n[ DEBUG    ]$(COLOR_SHELL_RESET) %s\n$(COLOR_SHELL_DEBUG)[----------]$(COLOR_SHELL_RESET)\n"
STRING_PRINT_RELEASE		=	"$(COLOR_SHELL_RELEASE)[----------]\n[ RELEASE  ]$(COLOR_SHELL_RESET) %s\n$(COLOR_SHELL_RELEASE)[----------]$(COLOR_SHELL_RESET)\n"
STRING_PRINT_TEST			=	"$(COLOR_SHELL_TEST)[----------]\n[ TEST     ]$(COLOR_SHELL_RESET) %s\n$(COLOR_SHELL_TEST)[----------]$(COLOR_SHELL_RESET)\n"
